...
public:
	...
	explicit NumberSetting(const std::string name, const Module* parent, const T min, const T max, const T default_value, const T increment, const std::function<bool(void)> dependency) :
