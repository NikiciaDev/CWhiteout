...
namespace font {
	...
	float height(const std::string string = "Whiteout", const sf::Font& font = font::mm, const unsigned short font_size = 14, const bool smart = false, const sf::Uint32 style = sf::Text::Regular);

	float width(const std::string string = "Whiteout", const sf::Font& font = font::mm, const unsigned short font_size = 14, const bool smart = false, const sf::Uint32 style = sf::Text::Regular, const float char_spacing = 1);
